...
import { getNewAppointmentFields } from "../../../modules/dashboard/new-appoinments/utils/fields-card-new-appointment";
...
const AppointmentCard = ({
    ...
    const fields = getNewAppointmentFields(appointment);
    ...
    return (
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50">
                <button
                    className="flex items-center gap-2 rounded-full border border-green-500 px-4 py-2 text-sm font-medium text-green-500 transition hover:bg-green-500 hover:text-white"
                >
                    <FaWhatsapp />
                    Contactar paciente
                </button>
